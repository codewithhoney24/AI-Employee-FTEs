# K-Electric AI Employee - Interaction Manager Control Script
# This script manages background services and the AI Engine in INTERACTION mode.
...
function Start-Services {
    Write-Host "Starting Interaction Manager Services..." -ForegroundColor Green
    ...
    # 2. AI Engine (INTERACTION MODE)
    Write-Host "[2/4] Starting AI Engine (Port 5000) - INTERACTION MODE..."
    $env:SCAN_MODE = "INTERACTION"
...
Write-Host "INTERACTION MANAGER IS ACTIVE" -ForegroundColor Green
Write-Host "1. Dashboard: http://localhost:3000"
Write-Host "2. WhatsApp: Open"
Write-Host "3. AI Engine: Interaction Mode"
Write-Host "=========================================="
